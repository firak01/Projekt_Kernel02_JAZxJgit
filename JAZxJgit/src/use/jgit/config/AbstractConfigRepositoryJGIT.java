 ...
 *
 */
public abstract class AbstractConfigRepositoryJGIT extends AbstractConfigJGIT implements IConfigRepositoryJGIT{
	...
	public AbstractConfigRepositoryJGIT() throws ExceptionZZZ{
		super();
	}
	public AbstractConfigRepositoryJGIT(String[] saArg) throws ExceptionZZZ {
		super(saArg); 
	} 
