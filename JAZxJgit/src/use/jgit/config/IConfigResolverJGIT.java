...
public interface IConfigResolverJGIT extends IConfigStarterLocalJGIT{
	...
	final static String sPATTERN4GIT_RESOLVER_DEFAULT="help|?|status|commit|resolveByStageState|searchConflictFiles:searchConflictFilesByScan:searchConflictFilesMarked|searchConflictFilesDeleted|resolveSearchedConflict:resolveSearchedConflictDeleted|resolveSearchedConflictMarked|resolveSearchedConflictMarkedCommit|rl:project:filepath:comment."; 
	                                                //Aktionen;
