...
public interface IConfigResolverJGIT extends IConfigStarterLocalJGIT{
	...
	final static String sPATTERN4GIT_RESOLVER_DEFAULT="help|?|status|commit|resolveByStageState|resolveDeleted|resolveConflict|resolveConflictCommit|searchConflictFiles|rl:project:filepath:comment."; 
	                                                //Aktionen;
