 ...
 * @author Fritz
 */
public class TestRepositoryFactoryHTTPS {
    ...
    private static RepositoryContext createClone(
        ...
        JgitRepositoryManagerHTTPS objRepositoryManager =
                new JgitRepositoryManagerHTTPS(configRepositoryManager);
        ...
        if(!FileEasyZZZ.exists(objRepositoryBaseDirectory)){
            throw new ExceptionZZZ(
                    ...
                    TestRepositoryFactoryHTTPS.class,
                    "createClone");
        }
        ...
        //---------------------------------------------------------
        // Starter erzeugen
        IJgitStarterHTTPS objStarter =
                new JgitStarterHTTPS(objStarterConfig);
