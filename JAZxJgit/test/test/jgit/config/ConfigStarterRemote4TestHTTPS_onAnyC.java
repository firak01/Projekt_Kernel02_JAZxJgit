...
public class ConfigStarterRemote4TestHTTPS_onAnyC  extends AbstractConfigStarterRemote4TestJGIT_onAnyX{
	
	public ConfigStarterRemote4TestHTTPS_onAnyC() throws ExceptionZZZ {
		super();		
	}
	...
	public String readRepositoryLocalBaseDirectory() throws ExceptionZZZ {				
		return ITestHelperConstant.sDirectoryRepoBaseC;
	}
}
