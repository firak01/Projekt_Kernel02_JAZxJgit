...
public class ConfigStarterRemote4TestHTTPS_onAny  extends ConfigStarterRemote4TestGIT_onAny{
	
	public ConfigStarterRemote4TestHTTPS_onAny() throws ExceptionZZZ {
		super();		
	}
